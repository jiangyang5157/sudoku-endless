...
public class NumberView extends View {
    ...
    public NumberView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NumberView, 0, 0);
        float textSize = typedArray.getFloat(R.styleable.NumberView_text_size, DEFAULT_TEXT_SIZE);
        int textColorResId = typedArray.getResourceId(R.styleable.NumberView_text_color, DEFAULT_COLOR_RES_ID);
        float strokeWidth = typedArray.getFloat(R.styleable.NumberView_stroke_width, DEFAULT_STROKE_WIDTH);
        mScale = typedArray.getFloat(R.styleable.NumberView_scale, DEFAULT_SCALE);
        ...
        mPaint.setColor(AppUtils.getColor(getContext(), textColorResId, null));
